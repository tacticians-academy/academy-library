...
export const augmentFlashcards: AugmentFlashcard[] = [
	...
	},
	{
		...
		tiers: [2],
		description: `Your Juggernauts deal {MinBonusDamage}% more damage, increased to {MaxBonusDamage}% for the rest of combat when they fall below 50% HP.  Gain 2 Juggernauts.`,
	...
	},
	{
		...
		name: `All Natural`,
		tiers: [1, 2],
		description: `Your champions with no items equipped gain {health} HP and heal for 1/2% of their max HP each second.`,
	...
	},
	{
		...
		name: `Army Building`,
		tiers: [1],
		description: `Gain a Lesser Champion Duplicator. This happens a second time after {PlayerCombatNum} player combats.`,
	...
	},
	{
		...
		tiers: [1, 2, 3],
		description: `At the start of the next {rounds} rounds, gain 4/6/11 gold.`,
	...
	},
	{
		...
		name: `Battle Ready`,
		tiers: [1, 2, 3],
		description: `Your team deals 3/6/8% more damage and takes {DR}% less damage. `,
	...
	},
	{
		...
		name: `Blood Money`,
		tiers: [1],
		description: `Gain 1 gold per {HPPerGold} HP your Tactician loses.`,
	...
	},
	{
		...
		tiers: [1, 2, 3],
		description: `Gain a random item component at the start of the next {roundsofbonusitems} rounds (including this round).`,
	...
	},
	{
		...
		tiers: [1],
		description: `Each time you level up, gain the same random Tier {UnitTier} champion.`,
	...
	},
	{
		...
		tiers: [3],
		description: `As you level, gain more powerful items.<br>Level {levelreqa} - Gain a component anvil<br>Level {levelreqb} - Gain a completed item anvil<br>Level {levelreqc} - Open a radiant item armory`,
	...
	},
	{
		...
		tiers: [2],
		description: `Gain a component anvil when you reach level {levelreqa}, {levelreqb}, {levelreqc}, and {levelreqd}`,
	...
	},
	{
		...
		tiers: [2],
		description: `Your units with Zaun's chem-mods gain 500 HP. Allies that start combat adjacent to them gain {SharedHP} HP. Gain 2 Zaun units.`,
	...
	},
	{
		...
		name: `Combat Caster`,
		tiers: [2],
		description: `Your units gain {shieldamount1}-{shieldamount4} Shield (based on current Stage) for 6 seconds after casting their spell.`,
	...
	},
	{
		...
		name: `Contagion`,
		tiers: [2],
		description: `Combat start: Infect the highest HP enemy, causing them to take 20% more damage. Every {SpreadTimer} seconds or on death, the infection spreads to {SpreadTargets} nearby enemies.`,
	...
	},
	{
		...
		tiers: [1, 2, 3],
		description: `1: Your champions holding an item gain {health} HP.  2: Your champions holding an item gain {health} health.`,
	...
	},
	{
		...
		tiers: [1, 2, 3],
		description: `Your units holding an item gain {health} HP and 13/18/25% Omnivamp.`,
	...
	},
	{
		...
		name: `Dedication`,
		tiers: [2],
		description: `The first time you field at least {NumUnits} distinct units of the same trait in player combat, gain an Emblem for that trait.`,
	...
	},
	{
		...
		name: `Defensive Dash`,
		tiers: [2],
		description: `Combat start and on takedown: Your Challenger units gain {MinShield}-225 Shield (based on current Stage) for 2.5 seconds. Gain 2 Challenger units.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Your Gunner units gain 8% Attack Speed, plus {StackingAS}% per Gunner stack. Gain 2 Gunners.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Your units permanently gain 1 Ability Power whenever they kill an enemy. Units start with {StartingAP} bonus Ability Power.`,
	...
	},
	{
		...
		name: `Endless Hordes`,
		tiers: [3],
		description: `Gain +{TeamSize} maximum team size, but your units can only hold 1 item and their total health is reduced by {HPReduction}%. Gain 6 gold.`,
	...
	},
	{
		...
		name: `Endless Hordes +`,
		tiers: [3],
		description: `Gain +{TeamSize} maximum team size, but your units can only hold 1 item and their total health is reduced by {HPReduction}%. Gain 9 gold.`,
		icons: [`assets/maps/tft/icons/augments/hexcore/100-duck-sized-horses-iii.tft_set9`],
	},
	{
	...
	},
	{
		...
		tiers: [2],
		description: `Your units gain 4% Attack Damage, 4 Ability Power, 4 Armor, and {MR} Magic Resist. Each time an allied unit dies, gain these stats again.`,
	...
	},
	{
		...
		name: `Gotta Go Fast!`,
		tiers: [1, 2],
		description: `Your units generate {PercentMana}% more Mana and move {BonusMovementSpeed}% faster.`,
	...
	},
	{
		...
		name: `Harmacist`,
		tiers: [1, 2, 3],
		description: `Your units heal for 10/15/25% of the damage they deal, and they convert {Conversion}% of excess healing to true damage on their next attack.`,
	...
	},
	{
		...
		name: `Haunted Shell`,
		tiers: [2],
		description: `If Shadow Isles is active, your units gain {StackingResistances} Armor and Magic Resistance for the rest of combat each time an ally dies. Gain 2 Shadow Isles units.`,
	...
	},
	{
		...
		tiers: [3],
		description: `Your max level is 7. Gain {augmentgold} gold.`,
	...
	},
	{
		...
		name: `Infusion`,
		tiers: [2],
		description: `Your units restore 20 Mana every {Interval} seconds.`,
	...
	},
	{
		...
		name: `Job's Done`,
		tiers: [1],
		description: `Gain {anvils} Component Anvils.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Your units deal {BaseDamageAmp}% increased damage. If you and your opponent have any of the same traits activated, they deal {FullDamageAmp}% increased damage instead.`,
	...
	},
	{
		...
		name: `Latent Forge`,
		tiers: [1],
		description: `Gain an Ornn Item Anvil after {NumberOfCombats} player combats.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Combat start: Your two furthest units form a bond, sharing {PercentShare}% of their Armor, Magic Resist, Attack Damage, and Ability Power with each other.`,
	...
	},
	{
		...
		name: `Mana Burn`,
		tiers: [2],
		description: `Gain a Shroud of Stillness. All enemies take {MaxHPPerSecond}% of their maximum HP as true damage each second until the first time they cast their Ability.`,
	...
	},
	{
		...
		name: `Martyr`,
		tiers: [2],
		description: `Whenever one of your units dies, all allies heal for {Missinghealth}% of their maximum HP.`,
	...
	},
	{
		...
		name: `Missing Link`,
		tiers: [1],
		description: `After you refresh your shop {RerollAmount} times, gain a copy of each Tier {UnitCost} unit. <br><br>(Refreshes this game: @TFTUnitProperty.item:TFT9_JackpotRolls@)`,
	...
	},
	{
		...
		tiers: [2],
		description: `You earn no interest but at the start of every player combat round gain 1 gold per {UnitsPerGold} units on your bench.`,
	...
	},
	{
		...
		tiers: [3],
		description: `Gain 25 gold. In {Numberofcombats} turns, gain 25 gold again.`,
	...
	},
	{
		...
		name: `Money Money!`,
		tiers: [2],
		description: `Gain 16 gold. In {Numberofcombats} turns, gain 16 gold again.`,
	...
	},
	{
		...
		name: `Money!`,
		tiers: [1],
		description: `Gain 11 gold. In {Numberofcombats} turns, gain 11 gold again.`,
	...
	},
	{
		...
		name: `On a Roll`,
		tiers: [1],
		description: `Whenever you star up a champion, gain a free shop refresh, up to {TurnLimit} time(s) per turn. Gain 2 Gold.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Combat start: Your Sorcerers gain {StartingBonusMana} mana. The first time each Sorcerer gets a takedown each combat, they gain {TakedownBonusMana} Mana. Gain 2 Sorcerers.`,
	...
	},
	{
		...
		name: `Patient Study`,
		tiers: [2],
		description: `After player combat, gain {winxp} XP if you won or {lossxp} XP if you lost. You can now reach Level 10.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Each time your Multicasters cast their Ability, they gain {StackingAP} Ability power (max: {MaxAP}) until the end of combat. Gain 2 Multicasters.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Your Demacians deal 15% more damage, increased to 22% against Noxians and enemies with {ManaThreshold} or more maximum Mana. Gain 3 Demacians.`,
	...
	},
	{
		...
		name: `Phreaky Friday`,
		tiers: [3],
		description: `Gain an Infinity Force. After {CombatNum} player combats, gain another.`,
	...
	},
	{
		...
		name: `Pumping Up`,
		tiers: [1, 2, 3],
		description: `1: Your units gain {BaseAS}% Attack Speed. Each round, increase this by {IncreasePerRound}%. (current Attack Speed: @TFTUnitProperty.item:TFT9_PumpingUpRounds@%)  2: Your units gain {BaseAS}% Attack Speed. Each round, increase this by {IncreasePerRound}%. (current Attack Speed: @TFTUnitProperty.item:TFT9_PumpingUp2Rounds@%)  3: Your units gain {BaseAS}% Attack Speed. Each round, increase this by {IncreasePerRound}%. (current Attack Speed: @TFTUnitProperty.item:TFT9_PumpingUp3Rounds@%)`,
	...
	},
	{
		...
		name: `Red Buff`,
		tiers: [1],
		description: `Your units' attacks burn their targets for 5% of their maximum HP over 5 seconds and reduce their targets' healing received by {HealingReductionPct}%.`,
	...
	},
	{
		...
		name: `Riftwalk`,
		tiers: [2],
		description: `Gain a Kassadin. Before casting, your strongest Kassadin gains 32 Ability Power and blinks to the furthest enemy within 3 hexes, but his spell no longer disarms or shields. His Mana cost is reduced by {ManaReduction}.`,
	...
	},
	{
		...
		name: `Risky Moves`,
		tiers: [1],
		description: `Your Tactician loses 20 HP, but after {PlayerCombatNum} player combats, gain 30 gold.`,
	...
	},
	{
		...
		tiers: [1, 2, 3],
		description: `Gain {Numrolls} free shop refreshes. These shop refreshes carry over between rounds.`,
	...
	},
	{
		...
		tiers: [2],
		description: `At the start of combat,  up to {MaxComponents} components on your champions turn into completed items for the rest of combat. At the start of the next {NumStages} stage(s), gain a component.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Your Piltover units deal {BonusDamageDealt}% more damage for every {GoldThreshold} gold you have (max: 40%), and have a {GoldChance}% chance to drop 2 gold at round start. Gain an Ekko.`,
	...
	},
	{
		...
		tiers: [2],
		description: `After {TooltipTimer} seconds of combat, the Sun Disc attacks enemies for {MinTurretDamage}-{MaxTurretDamage} magic damage every {AttackCadence} seconds (based on current Stage). Gain 3 Shurimans.`,
	...
	},
	{
		...
		tiers: [2],
		description: `When your Slayers take or deal damage, they gain {BonusResistances} stacking Armor and Magic Resistance for the rest of combat (max: 25 stacks). Gain 2 Slayers.`,
	...
	},
	{
		...
		name: `Spoils of War`,
		tiers: [1, 2, 3],
		description: `When you kill an enemy unit, there's a {LootDropChance}% chance to drop loot.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Your Void units gain {bonushealth} HP and 6% Attack Damage and Ability Power for each star level they have. Gain 3 Void units.`,
	...
	},
	{
		...
		name: `Starter Kit`,
		tiers: [3],
		description: `Gain a Tier 4 champion and a 2-star Tier 1 champion that shares a trait with them. At the next {FutureChampionCount} stages, gain the Tier 4 champion again.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Your units gain {HPPerUnit} HP for each unique Tier {Tier} unit you field. `,
	...
	},
	{
		...
		name: `Tons of Stats!`,
		tiers: [2],
		description: `Your team gains 35 HP, 5% Attack Damage, 5 Ability Power, 5 Armor, {MR} Magic Resist, 5% Attack Speed, and 5 Mana.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Noxus units' attacks and Abilities execute enemies below {BaseExecuteThreshold}% HP, increased by {StackingExecuteThreshold}% for each player you've Conquered. Gain 3 Noxians.`,
	...
	},
	{
		...
		name: `Transfusion`,
		tiers: [1, 2, 3],
		description: `Your units gain {BaseHP} HP, plus {BonusHPPerMissingHP} HP per missing Tactician HP.`,
	...
	},
	{
		...
		name: `Unburdened`,
		tiers: [1, 2],
		description: `Your units without items equipped gain 30/55% Attack Speed.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Round start: Gain a random Yordle or {MinGold}-{MaxGold} gold (based on current Stage). Gain 3 Yordles now.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Your units gain {BaselineOmnivamp}% Omnivamp. Your Rogues gain {RogueOmnivamp}% instead. Gain 2 Rogues.`,
	...
	},
	{
		...
		tiers: [3],
		description: `Gain a Training Dummy. It has {NumOfEmblems} random Emblems equipped, which cannot be removed. Gain 4 gold.`,
	...
	},
	{
		...
		name: `Wellness Trust`,
		tiers: [3],
		description: `Round start: Gain {GoldPerTurn} gold. If you have at least {GoldThreshhold} gold, your Tactician heals 2 HP.`,
	...
	},
	{
		...
		tiers: [2],
		description: `After losing your combat, gain 2 gold. Every {RoundsPerComponent} losses, gain a random component.<br><br><tftitemrules>Losses until next component: @TFTUnitProperty.item:TFT9_Augment_WhatDoesntKillYou_Counter@</tftitemrules>`,
