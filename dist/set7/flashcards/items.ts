...
export const itemFlashcards: ItemFlashcard[] = [
	...
	},
	{
		...
		name: `Blue Buff`,
		type: `completed`,
		description: `Grant 50 starting Mana (including components). After casting an Ability, set Mana to 20. [Unique - only 1 per champion]`,
	...
	},
	{
		...
		name: `Absolution`,
		type: `completed`,
		description: `Heal allies within 2 hexes for 18% of their missing HP every 5 seconds. They also take 25% less multi-target damage for 5 seconds (damage reduction does not stack). Radiant Bonus: 150 HP. ​​ [Aura item]`,
	...
	},
	{
		...
		name: `Blue Blessing`,
		type: `completed`,
		description: `Grant 50 starting Mana (including components). After casting an Ability, set Mana to 30 . Radiant Bonus: 30 Ability Power. [Unique - only 1 per champion]`,
	...
	},
	{
		...
		type: `completed`,
		description: `Combat start: Grant 50 Ability Power and {Spellvamp}% Omnivamp to the holder and allies within 1 hex in the same row. ​​ [Aura item]`,
	...
	},
	{
		...
		name: `Covalent Spark`,
		type: `completed`,
		description: `Enemies within 3 hexes have their Magic Resist reduced by 50%. When they cast an Ability, they are zapped for magic damage equal to 250% of their maximum Mana. Radiant Bonus: Regenerate {MaxHPRegen}% max HP per second. [Aura item] [Direct damage item]`,
	...
	},
	{
		...
		name: `Demonslayer`,
		type: `completed`,
		description: `Abilities and attacks deal 40% bonus damage. If the target has more than 2000 maximum HP, the bonus increases to 70% .`,
	...
	},
	{
		...
		name: `Dragon's Will`,
		type: `completed`,
		description: `Grant 180 bonus Magic Resist. Every {HPRegenInterval} seconds, regenerate 2.5% maximum HP for each enemy targeting the holder. If the holder is a Dragon, increase all bonuses and effects by {DragonValue}%.`,
	...
	},
	{
		...
		type: `completed`,
		description: `Grant 30 Armor and 30 Magic Resist for each enemy targeting the holder. Radiant Bonus: Regenerate {MaxHPRegen}% max HP each second.`,
	...
	},
	{
		...
		type: `completed`,
		description: `Dealing physical damage reduces the target's Armor by 50% for the rest of combat. This effect does not stack. Radiant Bonus: {BonusCritChance}% Critical Strike Chance. [Unique - only one per champion]`,
	...
	},
	{
		...
		type: `completed`,
		description: `Reduces the Attack Speed of enemies within 2 hexes by 50% . Radiant Bonus: {BonusMana} starting Mana. ​​[Aura item] [Unique - only 1 per champion]`,
	...
	},
	{
		...
		type: `completed`,
		description: `Grant 40% Critical Strike Damage and 60 bonus Ability Power (including components). Magic and true damage from an Ability can critically strike.`,
	...
	},
	{
		...
		type: `completed`,
		description: `Attacks grant +10% bonus Attack Speed. This effect stacks. Radiant Bonus: {RadiantBonusAS}% Attack Speed.`,
	...
	},
	{
		...
		type: `completed`,
		description: `Combat start: Shield the holder and allies within 3 hexes in the same row for 400/500/600 damage for 60 seconds. Radiant Bonus: +{BonusAllyHP} HP for all allies. ​​ [Aura item]`,
	...
	},
	{
		...
		type: `completed`,
		description: `Grant 55/85/115 bonus Attack Damage.`,
	...
	},
	{
		...
		type: `completed`,
		description: `Grant 80 bonus Ability Power. Magic or true damage from an Ability burns the target, dealing 60% of the target's maximum HP as true damage over 30 seconds, and reducing healing by 50% for the duration. [Unique - only 1 per champion]`,
	...
	},
	{
		...
		name: `Quickestsilver`,
		type: `completed`,
		description: `Grant 50% bonus Attack Speed. Combat start: Grant immunity to crowd control for 30 seconds. [Unique - only 1 per champion]`,
	...
	},
	{
		...
		type: `completed`,
		description: `Grant 125 bonus Ability Power.`,
	...
	},
	{
		...
		type: `completed`,
		description: `Grant 75% bonus Attack Speed and 2 Attack Range. Attacks cannot miss.`,
	...
	},
	{
		...
		name: `Rosethorn Vest`,
		type: `completed`,
		description: `Grant 130 bonus Armor. Negates all bonus damage from incoming critical strikes. On being hit by an attack, deal 125/175/225 magic damage to all nearby enemies (once every 2.5 seconds). [Direct damage item]`,
	...
	},
	{
		...
		type: `completed`,
		description: `Grant 10 Attack Damage. Attacks fire a bolt at a nearby enemy, dealing 110% Attack Damage as physical damage. Radiant Bonus: 30% Attack Speed. ​​[Direct damage item]`,
	...
	},
	{
		...
		type: `completed`,
		description: `Attacks restore 12 additional Mana. Radiant Bonus: 30 Ability Power.`,
	...
	},
	{
		...
		type: `completed`,
		description: `Grant 10% bonus Attack Speed. Every 3rd attack unleashes chain lightning that bounces to 8 enemies, dealing 75 magic damage and reducing their Magic Resist by 50% for 5 seconds. [Direct damage item]`,
	...
	},
	{
		...
		name: `Sunlight Cape`,
		type: `completed`,
		description: `Grant 600 bonus HP. Every 1.5 seconds, an enemy within 4 hexes is burned for 60% of their maximum HP as true damage over 30 seconds, and reducing healing by 50% for the duration. [Unique - only 1 per champion]`,
	...
	},
	{
		...
		type: `completed`,
		description: `Grant 40 bonus Ability Power. Combat start: Grant 25 Ability Power every 4 seconds.`,
	...
	},
	{
		...
		name: `Warmog's Pride`,
		type: `completed`,
		description: `Grant 1600 bonus HP. Radiant Bonus: Regenerate {MaxHPRegen}% max HP per second.`,
	...
	},
	{
		...
		name: `Zenith Edge`,
		type: `completed`,
		description: `Grant 75% Critical Strike Chance and 50% Critical Strike Damage. Each point of Critical Strike Chance above 100% converts to 1% Critical Strike Damage. [Unique - only 1 per champion]`,
	...
	},
	{
		...
		type: `completed`,
		description: `Combat start: A Radiant Voidmother with bonus HP and Attack Damage arises and taunts enemies within 4 hexes. Radiant Voidmothers that arise from summoned units are 25% effective.`,
	...
	},
	{
		...
		icon: `assets/maps/particles/tft/item_icons/shimmerscale/shimmerscale_crownofchampions_base.tft_set7`,
		from: [],
		unique: true,
	},
	{
		...
		icon: `assets/maps/particles/tft/item_icons/shimmerscale/shimmerscale_determinedinvestor_base.tft_set7`,
		from: [],
		unique: true,
	},
	{
		...
		icon: `assets/maps/particles/tft/item_icons/shimmerscale/shimmerscale_diamondhands_base.tft_set7`,
		from: [],
		unique: true,
	},
	{
		...
		icon: `assets/maps/particles/tft/item_icons/shimmerscale/shimmerscale_dravensaxe_base.tft_set7`,
		from: [],
		unique: true,
	},
	{
		...
		icon: `assets/maps/particles/tft/item_icons/shimmerscale/shimmerscale_goldcollector_base.tft_set7`,
		from: [],
		unique: true,
	},
	{
		...
		icon: `assets/maps/particles/tft/item_icons/shimmerscale/shimmerscale_goldmancersstaff_base.tft_set7`,
		from: [],
		unique: true,
	},
	{
		...
		name: `Mogul's Mail`,
		type: `completed`,
		description: `Grant {BaseResistsPerStack} Armor, {BaseResistsPerStack} Magic Resist, and {BaseHPPerStack} HP when taking damage, stacking up to 40 times. At full stacks, grant {GoldAtFullStacks} gold.`,
		icon: `assets/maps/particles/tft/item_icons/shimmerscale/shimmerscale_mogulsmail_base.tft_set7`,
		from: [],
		unique: true,
	},
	{
		...
		icon: `assets/maps/particles/tft/item_icons/shimmerscale/shimmerscale_heartofgold_base.tft_set7`,
		from: [],
		unique: true,
	},
	{
	...
	},
	{
		...
		name: `Manazane`,
		type: `completed`,
		description: `Once per combat: After casting a spell, restore 200 Mana over 5 seconds. [Unique - only 1 per champion]`,
	...
	},
	{
		...
		type: `completed`,
		description: `Combat start: Grant 50 Armor and 50 Magic Resistance to all adjacent allies, not including the holder. [Aura item]`,
