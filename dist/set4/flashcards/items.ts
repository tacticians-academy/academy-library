...
export const itemFlashcards: ItemFlashcard[] = [
	...
	},
	{
		...
		name: `Deathblade`,
		type: `completed`,
		description: `Contributing to a kill grants the holder +20 additional Attack Damage for the rest of combat. This effect can stack any number of times (starting at 1).`,
	...
	},
	{
		...
		name: `Giant Slayer`,
		type: `completed`,
		description: `The holder's spells and basic attacks do 10% bonus damage. If the target has more than 1750 maximum HP, the bonus increases to 90%.`,
	...
	},
	{
		...
		type: `completed`,
		description: `The holder's spells heal them for 33% of the damage dealt. Excess healing fuels a shield that protects the holder against up to 400 damage.`,
	...
	},
	{
		...
		name: `Zeke's Herald`,
		type: `completed`,
		description: `When combat begins, the wearer and all allies within 1 hexes in the same row gain +35% Attack Speed for the rest of combat.`,
	...
	},
	{
		...
		name: `Statikk Shiv`,
		type: `completed`,
		description: `Every third Basic Attack from the wearer deals 80 magic damage to 4/9/3 enemies, and 240 true damage if they are shielded.`,
	...
	},
	{
		...
		type: `completed`,
		description: `Basic Attacks fire a bolt at another nearby enemy, dealing 90% of the wearer's Attack Damage and applying on-hit effects. These bolts can critical strike.`,
	...
	},
	{
		...
		name: `Last Whisper`,
		type: `completed`,
		description: `When the wearer inflicts a critical hit, the target's Armor is reduced by 80% for 3 seconds. This effect does not stack. [Unique - Only One Per Champion]`,
	...
	},
	{
		...
		type: `completed`,
		description: `When combat begins, the wearer and all allies within 2 hexes in the same row gain a shield that blocks 300/375/500 damage for 8 seconds.`,
	...
	},
	{
		...
		type: `completed`,
		description: `When combat begins, the wearer and all allies within 1 hex in the same row gain 35 Spell Power for the rest of combat.`,
	...
	},
	{
		...
		type: `completed`,
		description: `The holder gains 15 Armor and 15 Magic Resist for each enemy targeting them.`,
	...
	},
	{
		...
		name: `Sunfire Cape`,
		type: `completed`,
		description: `Every 2 seconds, a random enemy within 2 hexes is burned for 25% of their maximum health over 10 seconds. Any healing they receive is reduced by 50%. [Unique - Only One Per Champion]`,
