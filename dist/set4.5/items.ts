...
export const completedItems: ItemData[] = [
	...
	{
		desc: `Every @ICD@ seconds, a random enemy within @HexRange@ hexes is burned for @BurnPercent@% of their maximum health over @BurnDuration@ seconds. Any healing they receive is reduced by @GrievousWoundsPercent@%.`,
		effects: {
			'Armor': 25,
			'HP': 200,
			'ICD': 2.5,
