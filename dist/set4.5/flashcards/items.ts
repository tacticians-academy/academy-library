...
export const itemFlashcards: ItemFlashcard[] = [
	...
	},
	{
		...
		name: `Sunfire Cape`,
		type: `completed`,
		description: `Every 2.5 seconds, a random enemy within 2 hexes is burned for 25% of their maximum health over 10 seconds. Any healing they receive is reduced by 50%.`,
