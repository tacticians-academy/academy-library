...
export const activeAugments: AugmentData[] = [
	...
	},
	{
		...
		desc: `Colossus become invulnerable for @InvulnDuration@ seconds when their Health drops to 60% and 30%.`,
		effects: {
			'InvulnDuration': 2,
		},
	...
	},
	{
		...
		name: `Duet`,
		groupID: `duet`,
		desc: `Summon 1 additional Socialite spotlight. Spotlighted units gain @BonusHealth@ Health.`,
		effects: {
			'BonusHealth': 400,
		},
	...
	},
	{
		...
		name: `Smoke Bomb`,
		groupID: `smokeBomb`,
		desc: `The first time an Assassin drops to @HealthThreshold@% health, they briefly enter stealth, becoming untargetable and shedding all negative effects. Any excess damage is reduced by @DamageReduction@%.`,
		effects: {
			'DamageReduction': 80,
			'HealthThreshold': 60,
			'{b1442c34}': 1.5,
	...
	},
	{
		...
		name: `Spell Blade`,
		groupID: `spellBlade`,
		desc: `After casting their Ability, Arcanists' next attack deals bonus magic damage equal to @PercentAbilityPower@% of their Ability Power. Spell Blade's damage is considered Ability damage.`,
		effects: {
			'PercentAbilityPower': 225,
		},
	...
	},
	{
		...
		desc: `Mutants randomly gain one of the following when they reach 2 star: @BonusHP@ Health, @BonusAS@% Attack Speed, @BonusAD@ Attack Damage, or @BonusAP@ Ability Power. These bonuses stack.`,
		effects: {
			'BonusAD': 30,
			'BonusAS': 30,
			'BonusHP': 500,
