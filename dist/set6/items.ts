...
export const completedItems: ItemData[] = [
	...
	{
		apiName: `TFT4_Item_DuskSpatulaItem`,
	...
	},
	{
		...
		desc: `Prevents the holder's first death, placing them in stasis instead. After @StasisDuration@ seconds, they return with @HPRestore@ HP and shed all negative effects.<br><br><tftitemrules>[Unique - only 1 per champion]</tftitemrules>`,
		effects: {
			'AD': 10,
			'Armor': 20,
			'HPRestore': 250,
...
export const spatulaItems: ItemData[] = [
	...
	{
		apiName: `TFT6_Item_ArcanistEmblemItem`,
	...
	{
		apiName: `TFT6_Item_BodyguardEmblemItem`,
	...
	{
		apiName: `TFT6_Item_BruiserEmblemItem`,
	...
	{
		apiName: `TFT6_Item_ChallengerEmblemItem`,
	...
	{
		apiName: `TFT6_Item_ChemtechEmblemItem`,
	...
	{
		apiName: `TFT6_Item_ClockworkEmblemItem`,
	...
	{
		apiName: `TFT6_Item_EnforcerEmblemItem`,
	...
	{
		apiName: `TFT6_Item_ImperialEmblemItem`,
	...
	{
		apiName: `TFT6_Item_InnovatorEmblemItem`,
	...
	{
		apiName: `TFT6_Item_MercenaryEmblemItem`,
	...
	{
		apiName: `TFT6_Item_MutantEmblemItem`,
	...
	{
		apiName: `TFT6_Item_ProtectorEmblemItem`,
	...
	{
		apiName: `TFT6_Item_ScholarEmblemItem`,
	...
	{
		apiName: `TFT6_Item_ScrapEmblemItem`,
	...
	{
		apiName: `TFT6_Item_SniperEmblemItem`,
	...
	{
		apiName: `TFT6_Item_SocialiteEmblemItem`,
	...
	{
		apiName: `TFT6_Item_SyndicateEmblemItem`,
...
export const ornnItems: ItemData[] = [
	...
	},
	{
		...
		desc: `The wearer's attacks and spell damage shred enemy Armor and Magic Resistance by 70% for @Duration@ seconds.<br><br><tftitemrules>[Unique - only 1 per champion]</tftitemrules>`,
		effects: {
			'AD': 30,
			'Duration': 3,
			'HP': 200,
