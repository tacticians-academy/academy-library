...
export const augmentFlashcards: ItemFlashcard[] = [
	...
	},
	{
		...
		name: `Bramble Vest`,
		type: `completed`,
		description: `Grants 70 bonus Armor (including components). Negates 100% bonus damage from incoming critical strikes. On being hit by an attack, deal 60/80/120 magic damage to all nearby enemies (once every 2.5 seconds).`,
	...
	},
	{
		...
		name: `Edge of Night`,
		type: `completed`,
		description: `When the holder first drops below 50% health, they briefly enter stealth, becoming untargetable and shedding negative effects. After coming out of stealth, the holder gains an additional 40% bonus Attack Speed. [Unique - only one per champion]`,
