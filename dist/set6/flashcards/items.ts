...
export const itemFlashcards: ItemFlashcard[] = [
	...
	},
	{
		...
		type: `completed`,
		description: `The wearer's attacks and spell damage shred enemy Armor and Magic Resistance by 70% for 3 seconds. [Unique - only 1 per champion]`,
	...
	},
	{
		...
		type: `completed`,
		description: `The first instance of damage that would reduce the wearer below {PercentHPThreshold}% HP is prevented, causing them to become invulnerable for 2.5 seconds. [Unique - only 1 per champion]`,
