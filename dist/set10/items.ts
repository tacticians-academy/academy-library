...
export const spatulaItems: ItemData[] = [
	...
	},
	{
		...
		associatedTraits: [],
		composition: [],
		desc: `The holder joins the Country band.<br><br><tftitemrules>[Unique - only 1 per champion<br>Elusive - cannot be crafted.]</tftitemrules>`,
		effects: {
			'HP': 150,
		},
		from: null,
	...
	},
	{
		...
		desc: `The holder joins the Jazz band.<br><br><tftitemrules>[Unique - only 1 per champion]</tftitemrules>`,
		effects: {
			'MR': 20,
		},
		from: null,
