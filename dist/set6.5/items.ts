...
export const emblemItems: ItemData[] = [
	...
	{
		apiName: `TFT6_Item_DebonairEmblemItem`,
	...
	{
		apiName: `TFT6_Item_HextechEmblemItem`,
	...
	{
		apiName: `TFT6_Item_StrikerEmblemItem`,
...
export const radiantItems: ItemData[] = [
	...
	},
	{
		...
		desc: `The holder's magic and true damage from Abilities heal them for <TFTRadiantItemBonus>@OmniVamp@%</TFTRadiantItemBonus> of the damage dealt. <TFTRadiantItemBonus>Excess healing fuels a shield that protects the holder against up to @ShieldMax@ damage.</TFTRadiantItemBonus> The holder also heals their lowest HP ally for the same amount.<br><br><TFTRadiantItemBonus>Radiant Bonus: +@BonusAP@ Ability Power.</TFTRadiantItemBonus>`,
		effects: {
			'AD': 10,
			'AP': 40,
			'ShieldMax': 300,
