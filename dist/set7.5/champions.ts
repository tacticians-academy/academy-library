...
export const champions: ChampionData[] = [
						...
						parts: [
							{
								...
								subparts: [
									{
										variable: `ADRatio`,
										starValues: [2.75, 2.75, 2.75, 2.75],
										stat: `AD`,
										ratio: 1,
									},
								],
	...
	},
	{
		...
		passive: {
			...
			missile: undefined,
			variables: {
				'BonusHealth': [0, 600, 900, 1500],
				'NumTargets': [0, 4, 4, 4],
				'DamagePerTarget': [0, 110, 165, 300],
				'NumAttacks': [3, 3, 3, 3],
			},
			calculations: {
				'{9e90f75f}': {
