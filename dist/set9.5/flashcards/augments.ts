...
export const augmentFlashcards: AugmentFlashcard[] = [
	{
		...
		name: `A Cut Above`,
		tiers: [2],
		description: `Gain a Deathblade. Champions holding Deathblade have a 25% chance to drop 2 gold on kill.`,
	...
	},
	{
		...
		name: `Latent Forge`,
		tiers: [1],
		description: `Gain an Artifact Anvil after 4 player combats.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Combat start: Your two furthest units form a bond, sharing 22% of their Armor, Magic Resist, Attack Damage, and Ability Power with each other.`,
	...
	},
	{
		...
		name: `Phreaky Friday +`,
		tiers: [3],
		description: `Gain an Infinity Force. After 2 player combats, gain another.`,
		icons: [`assets/maps/tft/icons/augments/hexcore/phreaky-friday-iii.tft_set9`],
	},
	{
		id: `piltover`,
	...
	},
	{
		...
		name: `Pumping Up`,
		tiers: [1, 2, 3],
		description: `1: Your units gain 5% Attack Speed. Each round, increase this by 1%. (current Attack Speed: @TFTUnitProperty.item:TFT9_PumpingUpRounds@%)  2: Your units gain 5% Attack Speed. Each round, increase this by 2%. (current Attack Speed: @TFTUnitProperty.item:TFT9_PumpingUp2Rounds@%)  3: Your units gain 12% Attack Speed. Each round, increase this by 4%. (current Attack Speed: @TFTUnitProperty.item:TFT9_PumpingUp3Rounds@%)`,
	...
	},
	{
		...
		tiers: [1, 2, 3],
		description: `1: After 4 player combats, gain 1 Training Dummy(s) equiped the with 1 random Support Item(s), which cannot be removed.  2: Gain 1 Training Dummy(s). They have 1 random Support Item(s) equipped, which cannot be removed.`,
