...
export const augmentFlashcards: AugmentFlashcard[] = [
	...
	},
	{
		...
		name: `Combat Caster`,
		tiers: [2],
		description: `Your units gain {shieldamount1}-{shieldamount4} Shield (based on current Stage) for 6 seconds after casting their ability.`,
	...
	},
	{
		...
		name: `Contagion`,
		tiers: [2],
		description: `Combat start: Infect the highest HP enemy, causing them to take 18% more damage. Every {SpreadTimer} seconds or on death, the infection spreads to {SpreadTargets} nearby enemies.`,
	...
	},
	{
		...
		tiers: [1, 2, 3],
		description: `Your units holding an item gain {health} HP and 10/15/20% Omnivamp.`,
	...
	},
	{
		...
		name: `Final Reserves`,
		tiers: [3],
		description: `The first time you would be eliminated or reduced to 1 HP, instead remain alive. Then, at the beginning of your next planning phase gain 70 XP and set your gold to 50. Excess gold is converted to XP.`,
	...
	},
	{
		...
		name: `Latent Forge`,
		tiers: [1],
		description: `Gain an Artifact Anvil after {NumberOfCombats} player combats.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Gain a Warwick. When your strongest Warwick takes or deals damage, he gains 5% Attack Damage and 5 Ability Power, stacking up to 50 times. His passive healing is replaced with magic damage on his attacks.`,
	...
	{
		id: `rejuventating flames`,
		name: `Rejuventating Flames`,
		tiers: [2],
		description: `Allies heal for {BaseRegen}% of their max HP every 5 seconds. Allies that started combat in an elemental hex heal for {StackingRegen}% instead. Gain 2 Ixtal champions.`,
	...
	},
	{
		...
		name: `Riftwalk`,
		tiers: [2],
		description: `Gain a Kassadin. Before casting, your strongest Kassadin gains 32 Ability Power and blinks to the furthest enemy within 3 hexes, but his ability no longer disarms or shields. His Mana cost is reduced by {ManaReduction}.`,
	...
	},
	{
		...
		tiers: [2],
		description: `After {TooltipTimer} seconds of combat, the Sun Disc attacks enemies for {MinTurretDamage}-{MaxTurretDamage} magic damage every {AttackCadence} seconds (based on current Stage). Gain 2 Shurimans.`,
	...
	},
	{
		...
		tiers: [1, 2, 3],
		description: `1: Your team counts as having 1 additional Slayer. Gain a Qiyana.  2: Gain a Slayer Emblem and a Qiyana.  3: Gain a Slayer Emblem, a Bloodthirster, and a Quinn.`,
	...
	},
	{
		...
		tiers: [1, 2, 3],
		description: `Combat start: Units with no adjacent allies gain 10/16/25% Attack Damage and Ability Power.`,
	...
	},
	{
		...
		tiers: [2],
		description: `Your Void units gain {bonushealth} HP and 6% Attack Damage and Ability Power for each star level they have. Gain 2 Void units.`,
	...
	},
	{
		...
		tiers: [1, 2, 3],
		description: `1: Gain {NumOfDummies} Training Dummy(s). In {PlayerCombatRounds} player combats, equip the dummy(s) with {NumOfItems} random Support Item(s), which cannot be removed.  2: Gain {NumOfDummies} Training Dummy(s). They have {NumOfItems} random Support Item(s) equipped, which cannot be removed.`,
	...
	},
	{
		...
		tiers: [2],
		description: `When your Vanquisher's attacks and Abilities critically strike, they heal the ally with the most missing HP by 3% of that ally's max HP. Gain 2 Vanquishers.`,
	...
	},
	{
		...
		name: `Teaming Up`,
		tiers: [1, 2, 3],
		description: `Gain 1/1/2 random Support item(s), 1/4/2 gold, and {NumReforgers} Reforger(s).`,
	...
	},
	{
		...
		tiers: [2],
		description: `Noxus units' attacks and Abilities execute enemies below {BaseExecuteThreshold}% HP, increased by {StackingExecuteThreshold}% for each player you've Conquered. Gain 2 Noxians.`,
	...
	},
	{
		...
		tiers: [1, 2, 3],
		description: `1: Your units gain 80 HP for each item equipped.  3: Your units gain 120 HP and 8% Attack Speed for each item equipped.`,
	...
	},
	{
		...
		name: `What The Forge`,
		tiers: [3],
		description: `All completed items you own or receive are transformed into random Artifacts (excluding Tactician's Crown and Emblems). Units gain 160 HP per equipped Artifact.`,
